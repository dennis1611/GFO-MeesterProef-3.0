...
public class ViewGRating extends AsyncTask<String, Void, List<String>> {

    Context context;
    public ViewGRating(Context ctx) {
        context = ctx;
    }
    ...
    protected List<String> doInBackground(String... params) {
        ...
        String view_url = "https://mantixcloud.nl/gfo/searchtool/gRatings.php";
        String result;
