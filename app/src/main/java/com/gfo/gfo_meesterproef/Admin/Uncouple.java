...
public class Uncouple extends AsyncTask<String, Void, String> {

    Context context;

    public Uncouple(Context ctx) {
        context = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "https://mantixcloud.nl/gfo/couple/uncouple.php";
        String result = null;
        if (type.equals("uncouple")) {
            try {
//                connect to database
