...
//                edit account (if a value has changed)
                ...
                if (newUsername.equals(oldUsername) && newPassword.equals(oldPassword) && newEmail.equals(oldEmail)) {
                    ...
                    new EditAccount(EditAccountActivity.this).execute(type, oldUsername, newUsername, newPassword, newEmail);
//                close Activity
...
//                delete account
                String type = "delete";
                new DeleteAccount(EditAccountActivity.this).execute(type, oldUsername);
//                close Activity
                Intent i = new Intent(EditAccountActivity.this, ViewAccountActivity.class);
                EditAccountActivity.this.finish();
                startActivity(i);
